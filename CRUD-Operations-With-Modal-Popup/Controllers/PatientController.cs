...
using CRUD_Operations_With_Modal_Popup.Models;
using Microsoft.AspNetCore.Mvc;
using Microsoft.AspNetCore.Mvc.Rendering;
using Microsoft.EntityFrameworkCore;

namespace CRUD_Operations_With_Modal_Popup.Controllers
{
    public class PatientController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("FristName,LastName,Address,DoctorId,AppointmentDate")] PatientRecordViewModel patientRecordViewModel)
        {
